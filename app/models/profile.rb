...
class Profile < ApplicationRecord
  ...
  enum siblings_relation: { unanswered: 0, oldest: 1, middle: 2, youngest: 3, have_no_siblings: 4 }, _suffix: true
  enum team_dev_will: { unanswered: 0, not_available: 1, would_love_to: 2, interested_but: 3 }, _suffix: true
